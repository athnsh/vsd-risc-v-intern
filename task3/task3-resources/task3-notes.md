...
![[Pasted image 20260611144344.png]]
...
installed
![[Pasted image 20260611145237.png]]
...
![[Pasted image 20260611175853.png]]
![[Pasted image 20260611180249.png]]
icestorm unavailable so installed fpga-icestorm package

![[Pasted image 20260611180541.png]]
cd ~
mkdir -p riscv_toolchain && cd riscv_toolchain
wget "https://static.dev.sifive.com/dev-tools/riscv64-unknown-elf-gcc-8.3.0-2019.08.0-x86_64-linux-ubuntu14.tar.gz"

now
![[Pasted image 20260611180703.png]]
tar -xvzf riscv64-unknown-elf-gcc-*.tar.gz

![[Pasted image 20260611180941.png]]
echo 'export PATH=$HOME/riscv_toolchain/riscv64-unknown-elf-gcc-8.3.0-2019.08.0-x86_64-linux-ubuntu14/bin:$PATH' >> ~/.bashrc
source ~/.bashrc
![[Pasted image 20260613014525.png]]

SETUP
![[Pasted image 20260613015004.png]]
...
![[Pasted image 20260613015418.png]]
looking at the code
`cd ~/vsdfpga_labs/basicRISCV/Firmware
nano riscv_logo.c  # Review and close (Ctrl+X)
make riscv_logo.bram.hex`
was success
![[Pasted image 20260613015833.png]]

```
make clean
make build
```
![[Pasted image 20260613015947.png]]
got this error

just removed the -abc9 -device u part from it and it ran
![[Pasted image 20260613130903.png]]
